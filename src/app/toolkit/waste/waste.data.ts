...
const FNB: WasteToolkitConfig = {
  ...
  mappingFields: [
    ...
    { label: 'Loại hình F&B', hint: 'VD: Nhà hàng, Quán cà phê, Foodservice, Bar/Bistro' },
...
/** Registry of all waste toolkit variants, keyed by id. */
export const WASTE_TOOLKITS: Record<string, WasteToolkitConfig> = {
  [FNB.id]: FNB,
  [SUPPLY.id]: SUPPLY,
