...
const FNB: QuickScanConfig = {
  ...
  profileFields: [
    ...
    { id: 'employees', label: 'Số lượng nhân viên' },
    { id: 'outlets', label: 'Số điểm bán / cơ sở' },
    { id: 'years-operating', label: 'Số năm hoạt động' },
    { id: 'assessor', label: 'Người thực hiện đánh giá' },
    { id: 'role', label: 'Vị trí / Bộ phận' },
    { id: 'assessment-date', label: 'Ngày đánh giá', type: 'date' },
    { id: 'esg-training', label: 'Đã từng tham gia đào tạo ESG chưa?', type: 'boolean' },
    {
      id: 'esg-concern',
...
const SUPPLY: QuickScanConfig = {
  ...
  profileFields: [
    ...
    { id: 'employees', label: 'Số lượng nhân viên' },
    { id: 'factories', label: 'Số nhà máy / xưởng sản xuất' },
    { id: 'years-operating', label: 'Số năm hoạt động' },
    {
      id: 'exports',
      label: 'Có xuất khẩu / cung ứng cho DN xuất khẩu?',
      hint: 'Có / Không / Đang lên kế hoạch',
    },
    { id: 'supplier-count', label: 'Số nhà cung cấp đang hợp tác (ước tính)' },
    { id: 'assessor', label: 'Người thực hiện đánh giá' },
    { id: 'role', label: 'Vị trí / Bộ phận' },
    { id: 'assessment-date', label: 'Ngày đánh giá', type: 'date' },
    {
...
/**
 * Bản TIẾNG VIỆT — nguồn chuẩn (canonical): migration localStorage v1→v2 build
 * map nhãn→id từ chính edition này, bất kể locale đang chạy.
 */
export const QUICK_SCANS_VI: Record<string, QuickScanConfig> = {
  [FNB.id]: FNB,
  [SUPPLY.id]: SUPPLY,
};
